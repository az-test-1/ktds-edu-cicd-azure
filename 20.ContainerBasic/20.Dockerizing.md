...
# Image build
$ docker build -t edu/samplejava:v1.0 .
...
# Docker run
$ docker run -d --name samplejava -p 8080:8080 edu/samplejava:v1.0
...

{
  "passwords": [
    {
      "name": "password",
      "value": "Z3bfUmNfyeEAwGDOaz9as4F0LOlxRTLGHgFDmycobU+ACRBP2Vpd"
    },
    {
      "name": "password2",
      "value": "hnGtR+d3uqUGulnuJgygqgCYwVdbdrZJO2+jxpnkmg+ACRC1Nu/7"
    }
  ],
  "username": "ktdseduacr"
}
...
# Docker tag
$ docker tag  edu/samplejava:v1.0 ktdseduacr.azurecr.io/edu/samplejava:v1.0

# push 
$ docker push ktdseduacr.azurecr.io/edu/samplejava:v1.0
...
# Delete image 
$ docker rmi edu/samplejava:v1.0
...
```sh
$ docker buildx build \
    --cache-from=type=registry,ref=ktdseduacr.azurecr.io/edu/samplejava:cache \
    --cache-to=type=registry,ref=ktdseduacr.azurecr.io/edu/samplejava:cache,mode=max \
    --push \
    -t ktdseduacr.azurecr.io/edu/samplejava:v1.0 .
...
$ docker builder prune -f
  docker rmi edu/samplejava:v1.0
  docker rmi ktdseduacr.azurecr.io/edu/samplejava:v1.0

# Docker 빌드 명령
$ time docker build --no-cache -t ktdseduacr.azurecr.io/edu/samplejava:v1.0 .
real    1m53.438s
user    0m2.664s
sys     0m1.686s
...
$ time \
  docker buildx build --no-cache \
    ...
    --push \
    -t ktdseduacr.azurecr.io/edu/samplejava:v1.0 \
    -t ktdseduacr.azurecr.io/edu/samplejava:latest \
    .
...
$ time \
  docker buildx build \
    ...
    --cache-to=type=registry,ref=ktdseduacr.azurecr.io/edu/samplejava:cache,mode=max \
    --push \
    -t ktdseduacr.azurecr.io/edu/samplejava:v1.1 \
    -t ktdseduacr.azurecr.io/edu/samplejava:latest \
    .
...
docker buildx build \
    ...
    --cache-to=type=registry,ref=ktdseduacr.azurecr.io/edu/samplejava:cache,mode=max \
    --load \
    -t ktdseduacr.azurecr.io/edu/samplejava:v1.2 .
...
```sh
# Docker 컨테이너 실행
$ docker run -d --name samplejava -p 8080:8080 ktdseduacr.azurecr.io/edu/samplejava:v1.0
...
```sh
# Docker 빌드 명령
$ docker build -t ktdseduacr.azurecr.io/edu/samplejava:v1.3 .
